...
INSERT INTO empleado (dni_empleado, nombre, apellido, fk_id_cargo, fecha_nacimiento, estado_empleado, telefono, email, genero) 
VALUES 
...
INSERT INTO computador (serial_computador, fk_cod_inventario, fecha_adquisicion, estado_equipo, observaciones_equipo, color, cantidad_memoria_ram, procesador, tipo, id_modelo_fk) 
VALUES 
('ABC123', 'INV1', '2023-01-15', 'bueno', 'Ninguna', 'Negro', 8, 'Intel Core i5', 'portatil', 'MOD1'),
('DEF456', 'INV2', '2023-03-20', 'regular', 'Algunos rasguños', 'Plata', 16, 'AMD Ryzen 7', 'escritorio', 'MOD2'),
('GHI789', 'INV3', '2023-05-10', 'bueno', 'Nuevo', 'Gris', 16, 'Intel Core i7', 'portatil', 'MOD3'),
('JKL012', 'INV4', '2023-07-25', 'regular', 'Leves rayones', 'Blanco', 8, 'HP Ryzen 5', 'escritorio', 'MOD4'),
('MNO345', 'INV5', '2023-09-18', 'bueno', 'Sin observaciones', 'Negro', 32, 'Apple M1', 'portatil', 'MOD5'),
('PQR678', 'INV6', '2023-11-30', 'malo', 'Pantalla rota', 'Negro', 4, 'AMD A6', 'escritorio', 'MOD6'),
('STU901', 'INV7', '2024-02-15', 'bueno', 'Nuevo', 'Gris', 8, 'Intel Core i5', 'portatil', 'MOD7'),
('VWX234', 'INV8', '2024-04-20', 'regular', 'Leves marcas de uso', 'Plata', 16, 'Intel Core i7', 'escritorio', 'MOD8'),
('YZA567', 'INV9', '2024-06-10', 'bueno', 'Sin observaciones', 'Negro', 8, 'AMD Ryzen 5', 'portatil', 'MOD9'),
('BCD890', 'IN10', '2024-08-05', 'regular', 'Algunos rasguños', 'Blanco', 4, 'Intel Core i3', 'escritorio', 'MOD10');
...
-- insers para la tabla acta
INSERT INTO acta (numero_acta, fecha_entrega, fecha_recibido, fk_serial_computador, fk_dni_empleado, estado_acta) 
VALUES 
(1, '2024-02-28', '2024-03-01', 'ABC123', 123456789, 'entraga'),
(2, '2024-02-28', '2024-03-01', 'DEF456', 987654321, 'recibido'),
(3, '2024-02-28', '2024-03-01', 'GHI789', 555555555, 'entraga'),
(4, '2024-02-28', '2024-03-01', 'JKL012', 444444444, 'recibido'),
(5, '2024-02-28', '2024-03-01', 'MNO345', 333333333, 'entraga'),
(6, '2024-02-28', '2024-03-01', 'PQR678', 222222222, 'recibido'),
(7, '2024-02-28', '2024-03-01', 'STU901', 666666666, 'entraga'),
(8, '2024-02-28', '2024-03-01', 'VWX234', 777777777, 'recibido'),
(9, '2024-02-28', '2024-03-01', 'YZA567', 888888888, 'entraga'),
(10, '2024-02-28', '2024-03-01', 'BCD890', 999999999, 'recibido');
